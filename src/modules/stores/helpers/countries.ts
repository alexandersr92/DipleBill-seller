export const countries = [
  ...
  { value: 'antigua_barbuda', label: 'Antigua y Barbuda' },
  ...
  { value: 'bosnia_herzegovina', label: 'Bosnia y Herzegovina' },
  ...
  { value: 'costa_marfil', label: 'Costa de Marfil' },
  ...
  { value: 'san_cristobal_nieves', label: 'San Cristóbal y Nieves' },
  { value: 'san_marino', label: 'San Marino' },
  { value: 'san_vicente_granadinas', label: 'San Vicente y las Granadinas' },
  { value: 'santa_lucia', label: 'Santa Lucía' },
  { value: 'santo_tome_principe', label: 'Santo Tomé y Príncipe' },
  ...
  { value: 'sudan_sur', label: 'Sudán del Sur' },
  ...
  { value: 'trinidad_tobago', label: 'Trinidad y Tobago' },
